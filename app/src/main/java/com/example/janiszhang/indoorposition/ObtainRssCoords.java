...
public class ObtainRssCoords {
	...
	public static void readOffLineRssData(String path, ArrayList<Entry<float[], float[]>> rssAndCoords) throws IOException {
		/*
	...
	public static float[] obtainCurCoordsOfRss(ArrayList<Entry<float[], float[]>> rssAndCoords) {
		/*
